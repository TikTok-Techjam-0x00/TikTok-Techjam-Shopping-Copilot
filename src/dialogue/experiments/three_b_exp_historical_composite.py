...
#
# Baseline:
#   Current production three_b.py at git commit 55f865b.
#
# Differences from current baseline:
#   Complete scoring policy from git commit b959324 is restored on the latest interfaces/extraction.
#
# Variables changed:
#   Historical Base, cumulative +12 Profile, +8/+5 Turn, lambda=38, ordinary coverage, and 5/K.
#
# Variables intentionally kept unchanged:
#   Latest interfaces, Top100, rank weight 1/sqrt(rank), and multi-value normalization.
#   Latest extraction, budget bins, feature filtering, and six-word use_case alignment.
#   Known/asked/no-preference exclusion, category hard gate, turn>=10 stop, and return schema.
#
# Purpose:
#   This variant changes multiple variables simultaneously.
#   It is intended as a historical composite reference,
#   not as a causal single-variable ablation.
#   Hypothesis: the complete historical policy may outperform isolated modern settings.
# ============================================================
