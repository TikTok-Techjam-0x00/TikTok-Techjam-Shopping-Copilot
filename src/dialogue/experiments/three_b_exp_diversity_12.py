...
#   Only DIVERSITY_COEFFICIENT changes from 18 to 12.
#
# Variables changed:
#   Lambda: 18 -> 12.
#
...
#
# Purpose:
#   Single-variable conservative dynamic-signal ablation.
#   Hypothesis: a weaker dynamic signal improves the balance with Base Priority.
# ============================================================
