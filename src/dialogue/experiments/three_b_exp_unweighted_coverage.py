...
#   Only coverage changes to covered_count/candidate_count.
#
# Variables changed:
#   Coverage: rank-weighted -> ordinary; entropy remains rank-weighted.
#
...
#   Current Base, lambda=18, no Profile/Turn/cardinality additions.
#
# Purpose:
#   Single-variable historical coverage ablation.
#   Hypothesis: ordinary coverage performs differently from rank-weighted coverage.
# ============================================================
