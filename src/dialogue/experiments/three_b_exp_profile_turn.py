...
#   Historical Profile Boost and Turn Boost from git commit b959324 are enabled.
#
# Variables changed:
#   Cumulative +12 profile tags and historical +8/+5 turn policy.
#
...
#   Current Base, lambda=18, weighted coverage/entropy, no cardinality penalty.
#
# Purpose:
#   This is an interaction variant, not a single-variable ablation.
#   Hypothesis: Profile and Turn Boosts have a joint effect absent in either-only variants.
# ============================================================
