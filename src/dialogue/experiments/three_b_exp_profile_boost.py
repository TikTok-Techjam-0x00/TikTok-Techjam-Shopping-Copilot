...
#   Historical Profile Boost from git commit b959324 is enabled.
#
# Variables changed:
#   Historical mapping; each profile tag adds +12 cumulatively.
#
...
#   Current Base, lambda=18, weighted coverage/entropy; no Turn or cardinality boost.
#
# Purpose:
#   Single-variable historical ablation of Profile Boost.
#   Hypothesis: historical Profile Boost changes end-to-end benchmark metrics.
# ============================================================
