...
#   Historical Turn Boost from git commit b959324 is enabled.
#
# Variables changed:
#   Turn<=2: category/use_case +8; turn>=4: feature/size/material/budget +5.
#
...
#   Current Base, lambda=18, weighted coverage/entropy; no Profile or cardinality boost.
#
# Purpose:
#   Single-variable historical ablation of fixed turn policy.
#   Hypothesis: historical Turn Boost changes end-to-end benchmark metrics.
# ============================================================
