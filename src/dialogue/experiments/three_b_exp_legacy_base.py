...
#   Only BASE_PRIORITY is restored from git commit b959324.
#
# Variables changed:
...
#   Lambda=18, weighted coverage/entropy, no Profile/Turn/cardinality additions.
#
# Purpose:
#   Single-variable historical Base Priority ablation.
#   Hypothesis: the historical semantic ordering changes end-to-end benchmark metrics.
# ============================================================
