...
#   None; behavior-identical copy with experiment documentation only.
#
# Variables changed:
#   None.
#
# Variables intentionally kept unchanged:
#   All production scoring, extraction, control flow, interfaces, and return structures.
#
# Purpose:
#   Baseline control for the same Orchestrator file-replacement workflow.
#   Hypothesis: this replacement path produces the same decisions as production.
# ============================================================
