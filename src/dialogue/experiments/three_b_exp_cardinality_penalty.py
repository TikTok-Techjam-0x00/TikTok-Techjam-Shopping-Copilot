...
#   Historical cardinality_factor=min(1, 5/K) from git commit b959324 is enabled.
#
# Variables changed:
#   Dynamic term is multiplied by min(1, 5/distinct_value_count).
#
...
#   Current Base, lambda=18, weighted coverage/entropy, no Profile/Turn Boost.
#
# Purpose:
#   Single-variable historical cardinality-penalty ablation.
#   Hypothesis: penalizing attributes with more than five values changes benchmark quality.
# ============================================================
